...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 5), // int()(double * *, double * *, double * *, int *, int, int *, int, int * *, double * *, int, double * *, double * *, double * *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 15), // double * *
...
/* 15 */ _CFFI_OP(_CFFI_OP_POINTER, 16), // double *
/* 16 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 14), // double
};

static int _cffi_d_calculate_sf(double * * x0, double * * x1, double * * x2, int * x3, int x4, int * x5, int x6, int * * x7, double * * x8, int x9, double * * x10, double * * x11, double * * x12)
{
  return calculate_sf(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_calculate_sf(PyObject *self, PyObject *args)
{
  double * * x0;
  double * * x1;
  double * * x2;
  ...
  if (!PyArg_UnpackTuple(args, "calculate_sf", 13, 13, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11, &arg12))
    return NULL;
  ...
  _cffi_restore_errno();
  { result = calculate_sf(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12); }
  _cffi_save_errno();
...
#else
#  define _cffi_f_calculate_sf _cffi_d_calculate_sf
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "calculate_sf", (void *)_cffi_f_calculate_sf, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_calculate_sf },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__libsymf(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__libsymf(void) { return NULL; }
#  else
     init_libsymf(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__libsymf(void)
{
  return _cffi_init("simple_nn.features.symmetry_function._libsymf", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_libsymf(void)
{
  _cffi_init("simple_nn.features.symmetry_function._libsymf", 0x2601, &_cffi_type_context);
}
#endif
